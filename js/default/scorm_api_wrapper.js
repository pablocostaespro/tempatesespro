...
pipwerks.SCORM = {                                  //Define the SCORM object
    ...
    lesson_status_incomplete: false
};
...
pipwerks.SCORM.connection.initialize = function(){
    ...
    if(!scorm.connection.isActive){
        ...
        if(API){
            ...
            switch(scorm.version){
                case "1.2" : API.LMSFinish(""); success = makeBoolean(API.LMSInitialize("")); break;
                case "2004": API.Terminate(""); success = makeBoolean(API.Initialize("")); break;
            }
            ...
            // console.log("lesson_status_incomplete "+ scorm.lesson_status_incomplete);
            if(scorm.lesson_status_incomplete){
